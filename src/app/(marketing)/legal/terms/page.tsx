...
import { termsMetadata, makeLegalJsonLd } from "../metadata";

export default function TermsOfServicePage() {
  const lastUpdatedISO = new Date().toISOString().split("T")[0];
  ...
  const jsonLd = makeLegalJsonLd(termsMetadata as any, lastUpdatedISO);
    ...
    <main className="mx-auto max-w-4xl px-4 py-16">
      ...
      <section className="space-y-6 text-foreground/80 text-sm leading-relaxed">
        ...
        <div className="border-t border-foreground/10 pt-6">
          ...
          <p className="mb-3">
            Some aspects of the Service may be provided on a subscription basis in the future. You will be billed in advance on a recurring
            and periodic basis ("Billing Cycle") if and when paid plans are introduced. Billing cycles may be set on a monthly or annual basis.
          </p>
          <p className="mb-3">
            A valid payment method, including credit card, is required to process the payment for any subscription. You shall provide accurate and complete billing information.
          </p>
          <p>
            If we introduce paid plans, you may cancel your subscription at any time through your account settings. Upon cancellation, you will
            continue to have access to the Service until the end of your current billing period unless otherwise specified.
          </p>
        </div>
        ...
        <div className="border-t border-foreground/10 pt-6">
          ...
          <p className="mb-3">
            We strive to provide uninterrupted service, but we cannot guarantee that the Service will be available at all times. We may experience hardware, software, or other problems or need to perform maintenance related to the Service, resulting in interruptions, delays, or errors.
          </p>
          <p>
