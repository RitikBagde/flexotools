...
import { cookiesMetadata, makeLegalJsonLd } from "../metadata";
...
export default function CookiePolicyPage() {
  ...
  const jsonLd = makeLegalJsonLd(cookiesMetadata as any, lastUpdatedISO);
    ...
    <main className="mx-auto max-w-4xl px-4 py-16">
      ...
      <section className="space-y-6 text-foreground/80 text-sm leading-relaxed">
        ...
        <div className="border-t border-foreground/10 pt-6">
          ...
          <p className="mb-3">We use first-party and third-party cookies for several reasons:</p>
        ...
        <div className="border-t border-foreground/10 pt-6">
          ...
          <div className="mt-4 p-4 bg-foreground/5 rounded-lg border border-foreground/10">
            ...
            <p className="mt-2 text-xs text-foreground/60">Duration: Session-based or up to 30 days</p>
          </div>
          ...
          <div className="mt-4 p-4 bg-foreground/5 rounded-lg border border-foreground/10">
            ...
            <p className="mt-2 text-xs text-foreground/60">Duration: Up to 1 year</p>
          </div>
          ...
          <div className="mt-4 p-4 bg-foreground/5 rounded-lg border border-foreground/10">
            ...
            <p className="mt-2 text-xs text-foreground/60">Duration: Up to 2 years</p>
          </div>
        ...
        <div className="border-t border-foreground/10 pt-6">
          ...
          <div className="mt-4 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
            <p className="text-yellow-700 dark:text-yellow-400 font-medium mb-2">⚠️ Important Note</p>
        ...
        <div className="border-t border-foreground/10 pt-6">
          ...
          <p className="mb-3">If you have any questions about our use of cookies or other technologies, please contact us:</p>
